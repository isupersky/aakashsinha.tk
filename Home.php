...
<div class="banner" id="home">
	<div class="container"> 
		<div class="top-header row">
			...
			<div class="logo">
				<a href="home.php"><h1>AAKASH SINHA</h1></a>
			</div>
			---->
			<div class="top-nav">
				<div class="nav-icon">
		...
		<div class="banner-info">
			<div class="banner-left">
				<img src="images/1.jpg" alt=" Display PIC" width="200" height="200"/>
			</div><br><hr>
			<div class="banner-right">
				<h1>I’M Aakash Sinha</h1>
				<div class="border"></div>
				<h2>UX - UI DESIGNER</h2>
				<a href="myresume.pdf" target="_blank">DOWNLOAD MY RESUME</a>
			</div>
			<div class="clearfix"></div>
		</div>
	</div>
...
<div class="about text-center" id="about">
	<div class="container">
		...
		<p>I am a final year Bachelors student of Computer Application from Indraprastha university looking for opportunities 
		to learn and excel . I have basic knowledge of C and C++ and various others, with a keen interest and profound knowledge 
		of JAVA programming.</p>
		<ul>
			<li><a class="fb" href="https://www.facebook.com/isupersky"></a></li>
			
			<li><a class="in" href="https://in.linkedin.com/in/aakash9868sinha"></a></li>
			
			<li><a class="goog" href="https://in.linkedin.com/in/aakash9868sinha"></a></li>
	...
	<div class="container">
		...
		<div class="edu-grids">
			<div class="col-md-4 edu-grid">
				<p>2002 - 2014</p><span>Schooling</span>
				<img src="images/arrow.png" alt=""/>
				<div class="edu-border">
					<div class="edu-grid-master">
						<h3>Central Board of Secondary Eduction (CBSE)</h3>
						<h4>St. Angel's sr. sec. school</h4>
					</div>
			...
			<div class="col-md-4 edu-grid">
				<p>2014 - 2017</p><span>Graduated</span>
				<img src="images/arrow.png" alt=""/>
				<div class="edu-border">
					<div class="edu-grid-master">
						<h3>BACHELORS DEGREE IN COMPUTER APPLICATIONS</h3>
						<h4>Indraprastha University</h4>
					</div>
					<div class="edu-grid-info">
						<h5>This is Photoshop's version Lorem Ipsum. 
						Well, the way they make shows is, they make one show.</h5>
		...
		<div class="contact-grids">
			<div class="col-md-5 contact-left">
				...
				<ul>
					...
					<li>XXXXXXXXXXXXXXXXX</li>
					<li>9958146938</li>
					<li><a href="mailto:aakash9868sinha@gmail.com">aakash9868sinha@gmail.com</a></li>
					<li><a href="home.php">www.aakashsinha.com</a></li>
				</ul>
			</div>
...
<div class="resume text-center">
	<div class="container">
		<div class="strip text-center"><a href="myresume.pdf" target="_blank"><img src="images/down.png" alt=" "/></a></div>
		<div class="down"><a href="myresume.pdf" target="_blank">Download My Resume</a></div>
	</div>
</div>
<!--//resume-->
...
<div class="footer">
	<div class="container">
		<p>Copyright &copy; 2019 Aakash Sinha.</p>
	</div>
</div>
<!--//footer-->
